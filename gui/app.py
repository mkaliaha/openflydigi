...
class App(QObject):
    ...
    def start(self, poll=True):
        ...
        self._profile.resetAllRequested.connect(worker.reset_all_profiles)
        ...
        worker.profiles_reset.connect(self._profile.forget)
        ...
        worker.third_party_written.connect(self._device.thirdPartyFinished)
        ...
        worker.setting_written.connect(self._settings.writeFinished)
        ...
        worker.dock_switch.connect(self._dock.switchFinished)
